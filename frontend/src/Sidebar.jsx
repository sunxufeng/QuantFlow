...
const navItems = [
  ...
  { key: 'paramgrid', label: '参数网格', abbr: '网' },
  { key: 'montecarlo', label: '鲁棒性模拟', abbr: '稳' },
  { key: 'walkforward', label: '样本外验证', abbr: '验' },
  { key: 'benchcmp', label: '基准对比', abbr: '比' },
  { key: 'factordecay', label: '因子衰减', abbr: '衰' },
  ...
  { key: 'optext', label: '组合优化增强', abbr: '增' },
